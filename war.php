<?php
//- необходимо преобразовать строку в таблице в полный метод для получения статуса армии
//- осуществить хранение юнитов без использования массива
// - реализовать интерфейс
// переписать функцию расчёта
include './Unit.php';
